#!/usr/bin/env python3
"""
Script principal simplificado para análisis de grafos.
...
def print_banner():
    ...
    print("=" * 70)
    print("    SISTEMA DE ANÁLISIS DE GRAFOS (VERSIÓN SIMPLIFICADA)")
...
def generate_comprehensive_report(citation_graph, cooccurrence_graph):
    ...
    # Guardar reporte
    with open('Data/simple_graph_analysis_report.json', 'w', encoding='utf-8') as f:
        json.dump(report, f, indent=2, ensure_ascii=False)
    
    print("✅ Reporte guardado en Data/simple_graph_analysis_report.json")
